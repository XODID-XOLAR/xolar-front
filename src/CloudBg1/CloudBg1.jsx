...
export const CloudBg1 = ({ className }) => {
  return (
    ...
    >
      <g className="g" filter="url(#filter0_bi_13_5171)">
        <path
          className="path"
          clipRule="evenodd"
          ...
          fill="url(#paint0_radial_13_5171)"
          fillRule="evenodd"
        />
      </g>
      <defs className="defs">
        ...
        >
          ...
          <feComposite
            ...
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_13_5171"
          />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_backgroundBlur_13_5171"
            mode="normal"
            result="shape"
          />
          <feColorMatrix
          ...
          />
          <feBlend className="fe-blend" in2="shape" mode="normal" result="effect2_innerShadow_13_5171" />
        </filter>
        <radialGradient
