...
import backgorund2 from "./backgorund-2.png";
  ...
  return (
    <div className="detail">
      <div className="div">
              ...
              <div className="crypto-wallet">
                ...
                <div className="frame-15">
                  <div className="frame-16">
                    ...
                    <OneThousandOneHundredAndTwentyNineKwh className="icon-instance-node" />
                  </div>
                  ...
                  <div className="frame-16">
                    ...
                    <SixHundredAndThreeKwh className="icon-instance-node" />
                  </div>
                </div>
                ...
                <div className="frame-15">
                  <div className="frame-16">
                    <div className="frame-12">
                      <div className="text-wrapper-12">9월 예상 수�입</div>
                    </div>

                    <OneHundredAndTwelveThousandNineHundred className="icon-instance-node" />
                  </div>
                  ...
                  <div className="frame-16">
                    ...
                    <SixtyThousandThreeHundred className="icon-instance-node" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="status-bar">
          <div className="battery">
            <div className="overlap-group-6">
              ...
              <Percentage className="percentage-instance" />
            </div>

            <BatteryEnd className="battery-end" />
          </div>

          <Wifi className="wifi-instance" />
          <MobileSignal className="mobile-signal" />
          <Time className="time-instance" />
        </div>
        ...
        <img className="backgorund" alt="Backgorund" src={backgorund2} />
      </div>
    </div>
  );
};
