...
export const CloudBg2 = ({ className }) => {
  return (
    ...
    >
      <g className="g" filter="url(#filter0_bi_17_9327)">
        <path
          className="path"
          clipRule="evenodd"
          ...
          fill="url(#paint0_radial_17_9327)"
          fillOpacity="0.8"
          fillRule="evenodd"
        />
      </g>
      ...
      <defs className="defs">
        ...
        >
          ...
          <feComposite
            ...
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_17_9327"
          />

          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_backgroundBlur_17_9327"
            mode="normal"
            result="shape"
          />
          ...
          <feBlend
            ...
            in2="shape"
            mode="normal"
            result="effect2_innerShadow_17_9327"
          />
        </filter>
