...
export const CloudBg = ({ className }) => {
  return (
    <svg
      className={`cloud-bg ${className}`}
      fill="none"
      height="15"
      viewBox="0 0 21 15"
      width="21"
    ...
    >
      <g className="g" filter="url(#filter0_bi_13_5104)">
        <path
          className="path"
          clipRule="evenodd"
          ...
          fill="url(#paint0_radial_13_5104)"
          fillOpacity="0.8"
          fillRule="evenodd"
        />
      </g>
      <defs className="defs">
        ...
        >
          ...
          <feComposite
            ...
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_13_5104"
          />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_backgroundBlur_13_5104"
            mode="normal"
            result="shape"
          />
          <feColorMatrix
          ...
          />
          <feBlend className="fe-blend" in2="shape" mode="normal" result="effect2_innerShadow_13_5104" />
        </filter>
        <radialGradient
