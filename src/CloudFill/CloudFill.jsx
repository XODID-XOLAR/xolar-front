...
export const CloudFill = ({ className }) => {
  return (
    ...
    >
      ...
      <g className="g" mask="url(#mask0_17_9276)">
        <g className="g" filter="url(#filter0_bi_17_9276)">
          <path
            className="path"
            clipRule="evenodd"
            d="M9.79514 11.3993H3.81606C3.81603 11.3993 3.816 11.3993 3.81597 11.3993C2.31253 11.3993 1.09375 10.1805 1.09375 8.67708C1.09375 7.5051 1.83436 6.50611 2.8731 6.12257C3.10763 4.23317 4.71898 2.77083 6.67188 2.77083C8.29563 2.77083 9.68326 3.78179 10.2397 5.20861C11.7473 5.42431 12.9062 6.72091 12.9062 8.28819C12.9062 10.0062 11.5137 11.399 9.79576 11.3993C9.79555 11.3993 9.79534 11.3993 9.79514 11.3993Z"
            fill="url(#paint0_radial_17_9276)"
            fillOpacity="0.85"
            fillRule="evenodd"
          />
        </g>
        ...
        <g className="g" mask="url(#mask1_17_9276)">
          <g className="g" filter="url(#filter1_i_17_9276)">
            <circle
              className="circle"
              cx="6.67188"
              cy="6.59896"
              fill="url(#paint1_linear_17_9276)"
              r="3.82812"
            />
          </g>
        </g>

        <g className="g" filter="url(#filter2_i_17_9276)">
          <circle
            className="circle"
            cx="3.81597"
            cy="8.67708"
            fill="url(#paint2_linear_17_9276)"
            r="2.72222"
          />
        </g>
        ...
        <g className="g" opacity="0.7">
          <circle
            ...
            cx="9.79514"
            cy="8.28819"
            fill="url(#paint3_linear_17_9276)"
            r="3.11111"
          />
        </g>
      </g>
      ...
      <defs className="defs">
        ...
        >
          ...
          <feComposite
            ...
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_17_9276"
          />

          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_backgroundBlur_17_9276"
            mode="normal"
            result="shape"
          />
          ...
          <feBlend
            ...
            in2="shape"
            mode="normal"
            result="effect2_innerShadow_17_9276"
          />
        </filter>
        ...
        >
          ...
          <feBlend
            ...
            in2="shape"
            mode="normal"
            result="effect1_innerShadow_17_9276"
          />
        </filter>
